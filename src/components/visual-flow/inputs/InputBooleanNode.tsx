...
function InputBooleanNode({ data, isConnectable, zIndex }: NodeProps<{ label: string }>) {
  return (
    <Card style={{ zIndex }} className="w-64 bg-yellow-500/20 shadow-lg border-yellow-500/80 border rounded-lg">
...
export default memo(InputBooleanNode);
