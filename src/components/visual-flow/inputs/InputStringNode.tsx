...
function InputStringNode({ data, isConnectable, zIndex }: NodeProps<{ label: string }>) {
  return (
    <Card style={{ zIndex }} className="w-64 bg-green-500/20 shadow-lg border-green-500/80 border rounded-lg">
...
export default memo(InputStringNode);
